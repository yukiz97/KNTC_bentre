...
public class LayoutDanhSachDonThuThamMuuChuaGQ extends LayoutDanhSachDonThu{
	...
	public LayoutDanhSachDonThuThamMuuChuaGQ() {
		lblMainCaption.setValue(FontAwesome.BOOK.getHtml()+" Quản lý danh sách đơn thư tham mưu chưa giải quyết");
		lblSubCaption.setValue("+ Quản lý danh sách đơn thư tham mưu cho đơn vị khác và chưa ban hành quyết định giải quyết");
	...
	public void loadData() throws Exception {
		...
		List<DonThuBean> list = svDonThu.getDonThuThamMuuChuaGiaiQuyet(modelFilter);
