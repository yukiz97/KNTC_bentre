...
public class LayoutDanhSachDonThuDangThiHanh extends LayoutDanhSachDonThu{
	...
	public LayoutDanhSachDonThuDangThiHanh() {
		lblMainCaption.setValue(FontAwesome.BOOK.getHtml()+" Quản lý danh sách đơn thư đang thi hành");
		lblSubCaption.setValue("+ Quản lý danh sách đơn thư đã được ban hành quyết định giải quyết và đang trong quá trình thi hành quyết định");
	...
	public void loadData() throws Exception {
		...
		List<DonThuBean> list = svDonThu.getDonThuDangThiHanh(modelFilter);
