package ngn.kntc.page.donthu.danhsach.giaiquyetdon;
...
public class LayoutDanhSachDonThuCanGiaiQuyet extends LayoutDanhSachDonThu{
	...
	public LayoutDanhSachDonThuCanGiaiQuyet() {
		lblMainCaption.setValue(FontAwesome.BOOK.getHtml()+" Quản lý danh sách đơn thư cần giải quyết");
		lblSubCaption.setValue("+ Quản lý danh sách đơn thư đã được thụ lý và đang trong quá trình giải quyết");
	...
	public void loadData() throws Exception {
		FilterDonCanGiaiQuyetBean modelFilter = new FilterDonCanGiaiQuyetBean();
		...
		List<DonThuBean> list = svDonThu.getDonThuCanGiaiQuyet(modelFilter);
