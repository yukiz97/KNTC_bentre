...
public class LayoutDanhSachDonPhucTapKeoDai extends LayoutDanhSachDonThu{
	...
	public LayoutDanhSachDonPhucTapKeoDai() {
		lblMainCaption.setValue(FontAwesome.BOOK.getHtml()+" Quản lý danh sách đơn thư phức tạp, kéo dài");
		lblSubCaption.setValue("+ Quản lý danh sách đơn thư đã được kết thúc sau khi ban hành quyết định giải quyết nhưng được đánh dấu là đơn phức tạo kéo dài");
	...
	public void loadData() throws Exception {
		...
		List<DonThuBean> list = svDonThu.getDonThuPhucTapKeoDai(modelFilter);
