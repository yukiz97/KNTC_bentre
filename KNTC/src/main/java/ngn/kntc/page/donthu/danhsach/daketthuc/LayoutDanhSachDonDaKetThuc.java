...
public class LayoutDanhSachDonDaKetThuc extends LayoutDanhSachDonThu{
	...
	public LayoutDanhSachDonDaKetThuc() {
		lblMainCaption.setValue(FontAwesome.BOOK.getHtml()+" Quản lý danh sách đơn thư đã kết thúc");
		lblSubCaption.setValue("+ Quản lý danh sách đơn thư đã được kết thúc sau khi ban hành quyết định giải quyết và thi hành");
	...
	public void loadData() throws Exception {
		...
		List<DonThuBean> list = svDonThu.getDonThuDaKetThuc(modelFilter);
