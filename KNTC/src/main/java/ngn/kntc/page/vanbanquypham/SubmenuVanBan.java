...
public class SubmenuVanBan extends FormSubMenu{
	public SubmenuVanBan() {
		buildNavigator();
	}
	public void buildMenu() {
		getSubMenuItems().clear();
		getSubMenuItems().put(ViewDanhSachVanBan.NAME, FontAwesome.BOOK.getHtml()+" <span>Danh sách văn bản</span>");
